...
### It was verified by the instructors, but things change often in Google Cloud Computing
...
## convert table to a json like object, turn PosTime back into numbers
